    ...
    <div className="flex justify-between items-center gap-2">
      ...
      >
        ...
        {cart.length ? (
          ...
          <span className="absolute -top-2 left-1 font-semibold   text-red-500 bg-amber-500 rounded-full px-[4px] py-0 -z-10 "></span>
        )}
      </button>
      <button
      ...
      <button
        className="block py-1 px-2 rounded-xl bg-red-500 opacity-50 transition-opacity duration-1000 hover:opacity-100"
        onClick={changeLanguage}
      >
        {i18n.language == "en" ? (
          <i className="fa-solid fa-globe text-base">
            <span className="text-sm m-1">En</span>
          </i>
        ) : (
          <i className="fa-solid fa-globe text-base">
            <span className="text-sm m-1">Ar</span>
          </i>
        )}
      </button>
